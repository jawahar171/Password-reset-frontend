...
//  Links to /forgot-password for reset flow.
// ─────────────────────────────────────────────
...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Save JWT — used by Axios interceptor for all protected requests
          ...
          <div className="col-12 col-sm-10 col-md-7 col-lg-5">
            <div className="auth-card fade-in-up">
              ...
              <div className="text-center mb-4">
                ...
                <h2 className="fw-bold mb-1" style={{ color: "#1a237e" }}>Welcome Back</h2>
